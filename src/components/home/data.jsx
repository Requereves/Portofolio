...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Nicholas M
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <h3 className="home_subtitle">Junior Web Developer</h3>
                <p className="home_description">Pemula Yg Sedang Berkenala </p>
                <a href="#" className="button button--flex">About Me
                <svg
                  class="button_icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
